...
# =============================================================================
    #ois_grouping = cf.group_ml(train_ois, cols=cols, method='Zackay')
    ...
    ml_results = cf.group_ml_parallel(dt_ois, und, cols=cols, method='Scorr',
    ...
    dump(knn_fsel_scores, os.path.join(plots_path, 'knn_fsel_scores_sps.joblib'))
    ...
    dump(record, os.path.join(plots_path, 'record_sps.joblib'))
